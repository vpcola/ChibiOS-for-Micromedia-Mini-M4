...
/*
 * Setup for MikroElektronika Mini-M4 board board.
 */

/*
 * Board identifier.
 */
#define BOARD_MIKROE_MINI_M4
#define BOARD_NAME                  "MikroElektronika Mini-M4 board"
...
#define GPIOC_LED_YELLOW            12
#define GPIOC_LED_RED               13
 ...
 * PB12 - SPI2_NSS                  (output pushpull low).
 ...
 * PC12 - LED_YELLOW                (output pushpull low).
 * PC13 - LED_RED                   (output pushpull low).
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_100M(GPIOC_PIN0) |          \
                                     ...
                                     PIN_OSPEED_25M(GPIOC_LED_YELLOW) |     \
                                     PIN_OSPEED_25M(GPIOC_LED_RED) |        \
